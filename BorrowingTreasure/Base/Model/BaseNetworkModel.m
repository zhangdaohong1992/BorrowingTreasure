...
- (void)postWithParameter:(NSDictionary *)parameter method:(NSString *)method isHud:(BOOL)isHud
{
    ...
    [self.manager POST:method parameters:tempDic progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        if (!delegates.isreach) {
            [ResponseModel showInfoWithString:@"网络不通畅,请再试一次!"];
...
- (void)getWithMethod:(NSString *)method isHud:(BOOL)isHud
{
    ...
    [self.manager GET:method parameters:nil progress:^(NSProgress * _Nonnull downloadProgress) {
...
- (void)getWithMethod:(NSString *)method Parameter:(NSDictionary *)parameter isHud:(BOOL)isHud
{
    ...
    [self.manager GET:method parameters:parameter progress:^(NSProgress * _Nonnull downloadProgress) {
